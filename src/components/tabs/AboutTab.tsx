export function AboutTab() {
  return (
    <div className="about-copy">
      ...
      <p>
        Spirit Island Randomizer creates complete Spirit Island setups from the
        pools and options you choose.
      </p>
      <p>
      ...
      <div className="disclaimer">
        <strong>Unofficial Fan-Made Tool</strong>
        <p>
      ...
      <ul>
        ...
        <li>
          <strong>Tailwind CSS</strong> &mdash; utility-first styling framework.
          <br />
          Licensed under the{" "}
          <a
            href="https://opensource.org/licenses/MIT"
      ...
      <p>
        You may share this software freely with attribution. You may not use it
        for commercial purposes or distribute modified versions.
      </p>
    </div>
  );
}
